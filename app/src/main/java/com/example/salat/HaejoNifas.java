...
public class HaejoNifas extends AppCompatActivity implements View.OnClickListener {
private Button b1,b2,b3,b4;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_haejo_nifas);

        b1=(Button)findViewById(R.id.haejnifasistihajaid);
        b1.setOnClickListener(this);
        b2=(Button)findViewById(R.id.haejerharamkajid);
        b2.setOnClickListener(this);
        b3=(Button)findViewById(R.id.nifaserbiboronid);
        b3.setOnClickListener(this);
        b4=(Button)findViewById(R.id.istihajarbiboronid);
        b4.setOnClickListener(this);
    }

    @Override
    public void onClick(View view) {
        if(view.getId()==R.id.haejnifasistihajaid)
        {
            Intent intent=new Intent(HaejoNifas.this,HaejerVumica.class);
            startActivity(intent);
        }
        else if(view.getId()==R.id.haejerharamkajid)
        {
            Intent intent=new Intent(HaejoNifas.this,HaejerHaramKaj.class);
            startActivity(intent);
        }
        else if(view.getId()==R.id.nifaserbiboronid)
        {
            Intent intent=new Intent(HaejoNifas.this,NifaserBiboron.class);
            startActivity(intent);
        }
        else if(view.getId()==R.id.istihajarbiboronid)
        {
            Intent intent=new Intent(HaejoNifas.this,IstihajarBivoron.class);
            startActivity(intent);
        }
    }
