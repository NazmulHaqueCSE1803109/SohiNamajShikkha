...
public class ChitrosohoNamaz extends AppCompatActivity implements View.OnClickListener{
private Button b1,b2;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_chitrosoho_namaz);

        b1=(Button)findViewById(R.id.chitrosohopurushernamazid);
        b1.setOnClickListener(this);
        b2=(Button)findViewById(R.id.chitrodohomohiladernamazid);
        b2.setOnClickListener(this);
    }

    @Override
    public void onClick(View view) {
        if(view.getId()==R.id.chitrosohopurushernamazid)
        {
            Intent intent=new Intent(ChitrosohoNamaz.this,ChitroSohoPurusherNamaz.class);
            startActivity(intent);
        }
        else
        {
            Intent intent=new Intent(ChitrosohoNamaz.this,ChitroSohoMohiladerNamaz.class);
            startActivity(intent);
        }
    }
