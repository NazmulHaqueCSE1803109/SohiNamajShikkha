...
public class NamazerForojSunnatOwajib extends AppCompatActivity implements View.OnClickListener {
private Button b1,b2,b3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_namazer_foroj_sunnat_owajib);

        b1=(Button)findViewById(R.id.namazerforojid);
        b1.setOnClickListener(this);
        b2=(Button)findViewById(R.id.namazeroajibid);
        b2.setOnClickListener(this);
        b3=(Button)findViewById(R.id.namazersunnatid);
        b3.setOnClickListener(this);
    }

    @Override
    public void onClick(View view) {
        if(view.getId()==R.id.namazerforojid)
        {
            Intent intent=new Intent(NamazerForojSunnatOwajib.this,NamazerForoj.class);
            startActivity(intent);
        }
        else if(view.getId()==R.id.namazeroajibid)
        {
            Intent intent=new Intent(NamazerForojSunnatOwajib.this,NamazerOajib.class);
            startActivity(intent);
        }
        else if(view.getId()==R.id.namazersunnatid)
        {
            Intent intent=new Intent(NamazerForojSunnatOwajib.this,NamazerSunnat.class);
            startActivity(intent);
        }
    }
