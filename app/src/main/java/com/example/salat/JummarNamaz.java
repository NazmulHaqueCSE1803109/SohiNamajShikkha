...
public class JummarNamaz extends AppCompatActivity implements View.OnClickListener {
private Button b1,b2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_jummar_namaz);

        b1=(Button)findViewById(R.id.jummarnamazerniotid);
        b1.setOnClickListener(this);
        b2=(Button)findViewById(R.id.jummarnamazerfojilotid);
        b2.setOnClickListener(this);
    }

    @Override
    public void onClick(View view) {
        if(view.getId()==R.id.jummarnamazerniotid)
        {
            Intent intent=new Intent(JummarNamaz.this,JummarNamazerNiot.class);
            startActivity(intent);
        }
        else if(view.getId()==R.id.jummarnamazerfojilotid)
        {
            Intent intent=new Intent(JummarNamaz.this,JummaNamazerFojilot.class);
            startActivity(intent);
        }
    }
